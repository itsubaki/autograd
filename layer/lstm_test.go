...
func ExampleLSTM() {
	...
	// h2f.w[2 2]([0.4006014980172961 -0.4330302800303532 0.4171185512277987 -0.260091010167568])
	// h2i.w[2 2]([0.7721305559619605 -0.3138383577766621 -0.1774465290440516 0.6058784343349307])
	// h2o.w[2 2]([0.5131618329299671 0.6022410956921772 -1.4567160689766936 -0.4395064776168111])
	// h2u.w[2 2]([-0.1863471272377204 -0.2731476909916124 -0.22971366432393717 -0.9748342951297205])
	// x2f.b[1 2]([0 0])
	// x2f.w[1 2]([1.4794951368388003 -0.7850500761442023])
	// x2i.b[1 2]([0 0])
	// x2i.w[1 2]([0.6683845105491564 0.5224173744445297])
	// x2o.b[1 2]([0 0])
	// x2o.w[1 2]([0.14228008038102535 0.49557472469859015])
	// x2u.b[1 2]([0 0])
	// x2u.w[1 2]([-0.3459245000660268 2.3596405779473866])
}
