...
func ExampleRNN() {
	...
	// h2h.w[2 2]([0.4006014980172961 -0.4330302800303532 0.4171185512277987 -0.260091010167568])
	// x2h.b[1 2]([0 0])
	// x2h.w[1 2]([1.0919575041640825 -0.4438344619606553])
}
...
func ExampleRNN_backward() {
	...
	// .
	// h2h.h2h.w variable[2 2]([0.22839718521198515 0.5180241623919872 -0.11935935508160048 -0.2707171276318745])
	// x2h.x2h.b variable[1 2]([0.5896143925532906 1.4348651282031906])
	// x2h.x2h.w variable[1 2]([0.5896143925532906 1.4348651282031906])
}
