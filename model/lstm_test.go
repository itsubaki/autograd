...
func ExampleLSTM_backward() {
	...
	// w variable[2 1]([[0.013515028138341746] [0.027030056276683492]])
	// w variable[2 1]([[0.04252623292012907] [0.08505246584025813]])
	// b variable(0.05279536845172966)
	// b variable(0.013515028138341746)
	// b variable(0.04252623292012907)
	// w variable[2 1]([[0.05279536845172966] [0.10559073690345933]])
	// b variable(-0.00757230286787535)
	// w variable[2 1]([[-0.00757230286787535] [-0.0151446057357507]])
